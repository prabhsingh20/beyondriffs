...
function HeroSection() {
  return (
    <section className="bg-black">
      <div className="bg-hero h-screen bg-right bg-no-repeat text-white">
        <div className="flex flex-col gap-3 pl-24 pt-20">
          ...
          <p className="w-[620px] tracking-wider">
          ...
          <div className="mt-6 flex gap-8">
            <LinkCustom className="text-xl">Book free trial</LinkCustom>
            <LinkCustom className="border-[1px] border-[#8510C8] bg-none shadow-none">
              Teach with us
            </LinkCustom>
          </div>
        </div>
